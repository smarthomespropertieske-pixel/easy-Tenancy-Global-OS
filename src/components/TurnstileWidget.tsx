...
const TurnstileWidget = forwardRef<TurnstileHandle, TurnstileWidgetProps>(
  function TurnstileWidget({
    ...
    const envSitekey = (import.meta as any).env?.VITE_TURNSTILE_SITE_KEY;
    const isValidEnvSitekey = envSitekey && !envSitekey.includes('=') && !envSitekey.includes(' ');
    const sitekey = propSitekey || (isValidEnvSitekey ? envSitekey : TEST_SITEKEY);
