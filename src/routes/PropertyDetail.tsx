...
export default function PropertyDetail() {
  ...
  return (
    <motion.div initial="initial" animate="enter" exit="exit" variants={PAGE_VARIANTS} style={{
      ...
      <SEO title={property.name} description={`Property with ${property.units} units.`} url={`/org/${orgId}/properties/${propId}/${section}`} />
      {/* ── Sticky header ── */}
      <div style={{
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <button
              ...
              style={{
                fontSize: 12, background: 'rgba(255,255,255,0.06)', color: '#f1f5f9', borderRadius: 6, padding: '4px 12px',
                border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6
              }}
            >
